...
export default function NewPetScreen() {
  ...
  return (
    <ScrollView className="flex-1 bg-bg" contentContainerClassName="p-6">
      ...
      <Text className="text-ink-soft mb-6">Sumá un compañero a tu familia</Text>
      ...
      <View className="space-y-4">
        ...
        <View>
          <Text className="text-sm font-medium text-ink-soft mb-1.5">Especie *</Text>
              ...
              >
                <Text
                  className={`font-medium ${
                    species === s ? "text-white" : "text-ink-soft"
                  }`}
                >
                  {s}
                </Text>
        ...
        <View className="flex-row gap-3 pt-4">
          ...
          <View className="flex-1">
            <Button onPress={onSave} size="lg" className="w-full">Guardar</Button>
          </View>
        </View>
      </View>
    </ScrollView>
